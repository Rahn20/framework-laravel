...
@section('title', 'Framework | Game21')
...
@section('content')
    ...
    <form method="POST" action="{{ route('play-game') }}">
        ...
        <p><a href="{{ route('destroy-game') }}"> Nollställ poäng </a> </p>
    </form> 
    ...
    @if (Session::has('play'))
        ...
        @else 
            ...
            <p>Totalt spelare poäng: {{ Session::get('play.playerPoints') }} </p>
            <p>Totalt dator poäng: {{ Session::get('play.computerPoints') }}</p>
        @endif
